export default function(server) {
  ...
  server.create('post', {
    ...
    tagline:'',
    body:[
        'This is part of two articles that address learning programming.',
  ...
  server.create('post', {
    ...
    tagline:'',
    body:[
        'I prepared for my career in software development by attending a'+
  ...
  server.create('post', {
    ...
    tagline:'',
    body:[
        'On August 31, 2015, I started an intensive, 12-week'+
  ...
  server.create('post', {
    ...
    tagline:'',
    body:[
        'I presented my favorite parts about building this website at the Triangle Ember meetup'+
        ...
        ' and starting doing front end engineering earlier this year,'+
        ' so I immediately wanted to use a database'+
  ...
  server.create('post', {
    ...
    tagline:'',
    body:[
        'I participated in two 8-hour days of Ember workshops led by Chase McCarthy '+
  ...
  server.create('post', {
    ...
    tagline:'',
    body:[
        'I helped lead a community discussion at Bronto Software in Durham, NC.'+
